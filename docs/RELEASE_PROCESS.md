...
The committed `0.4.0` version is an alpha source boundary. It does not imply a Git tag, GitHub
...
6. clean-wheel SARIF, CycloneDX, exposure-context and portfolio smoke tests;
...
`main` SHA has passed the same gates. Package publication and deployment are not part of v0.4.
